              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="w-full justify-start gap-3 h-auto py-2 px-3 text-sidebar-foreground hover:bg-sidebar-accent">
                  ...
                  <div className="flex-1 text-left">
                    <p className="text-sm font-medium truncate">{profile?.name || profile?.company_name || 'Company'}</p>
                    <p className="text-xs text-sidebar-foreground/60 capitalize">{role || 'company'}</p>
                  </div>
